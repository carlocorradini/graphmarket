...
import authorizationMiddleware from '@app/authorizationMiddleware';

type DeepPartial<T> = {
  [P in keyof T]?: DeepPartial<T[P]>;
};

const createResolverData = (context: IGraphQLContext = {}): ResolverData<IGraphQLContext> => ({
...
const createContext = (partialContext: DeepPartial<IGraphQLContext> = {}): IGraphQLContext => {
